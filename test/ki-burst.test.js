...
test('KI Burst opens exactly one dedicated burst session and completes with exactly three sequential frames', async () => {
    ...
    const handled = fixture.controller.handleWorkerMessage({ type: 'burst_complete', burstId, frames, paths: ['/data/1.jpg', '/data/2.jpg', '/data/3.jpg'], intervalMs: 800, frameOffsetsMs: [0, 800, 1600], capturedAt: '2026-09-05T15:00:00.000Z' })
