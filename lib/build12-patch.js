...
import { KiBurstController, KI_BURST_FRAME_COUNT, KI_BURST_INTERVAL_MS } from './ki-burst-controller.js'
...
function publishBurstState(camera, status, details = {}) {
    ...
    const attrs = {
        ...
        frameOffsetsMs: details.frameOffsetsMs || [0, KI_BURST_INTERVAL_MS, KI_BURST_INTERVAL_MS * 2],
        paths: details.paths || [],
