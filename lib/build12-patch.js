...
export function publishBurstState(camera, status, details = {}) {
    ...
    if (status === 'complete' && Array.isArray(details.frames)) {
        try {
            ...
            persistKiBurstFrame1(details.paths[0], composed.frames[0])
            ...
            details = {
                ...
                outputFrameSourceIndices: [null, selectorSourceIndices[1] ?? null, selectorSourceIndices[2] ?? null],
                snapshotCapturedAt,
