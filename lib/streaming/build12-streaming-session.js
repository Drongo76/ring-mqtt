...
export function getObservationStopDelayMs(observationWindowMs, hardDeadlineMs, nowMs) {
    return Math.min(observationWindowMs, Math.max(1, hardDeadlineMs - nowMs))
}
...
export class Build12StreamingSession extends StreamingSession {
    async captureJpegBurst({
        ...
        const startObservationWindow = () => {
            ...
            const observationDelayMs = getObservationStopDelayMs(observationWindowMs, hardDeadline, firstCleanWallClockMs)
